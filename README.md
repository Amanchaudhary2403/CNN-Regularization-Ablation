...
<img src="https://img.shields.io/badge/TensorFlow-2.15-00FFFF?style=for-the-badge&logo=tensorflow&logoColor=black" alt="TensorFlow"/>
<img src="https://img.shields.io/badge/CIFAR--10-5K%20samples-BF00FF?style=for-the-badge&logoColor=white" alt="Dataset"/>
<img src="https://img.shields.io/badge/Variants-6%20Models-FF0080?style=for-the-badge&logoColor=white" alt="Variants"/>
...
| `FRAMEWORK` | `DATASET` | `TRAIN SIZE` | `VARIANTS` | `OPTIMIZER` | `SEED` |
|:---:|:---:|:---:|:---:|:---:|:---:|
| TensorFlow 2.15 | CIFAR-10 | 5,000 imgs | 6 CNNs | Adam + CosineDecay | 42 |

<br>

```
┌─────────────────────────────────────────────────────────────────────┐
│  KEY FINDING:  The best model (M4) used NO augmentation.           │
...
| `M5_BN_Drop_Aug` | 68.7% | 66.6% | 67.8% | ⚪ −0.4% | 94 | Augmentation hurt, not helped |
...
`M5` added `RandomRotation(0.05)`, `RandomZoom(0.05)`, and `RandomContrast(0.1)` on top of M4. It scored **68.7%** — *1.8% lower* than M4 with no augmentation.
...
Tracks how the Train − Val accuracy gap evolves per epoch. M1 and M2 blow up above 0.4. M4 stabilises near 0.12. M5 and M6 dip below zero — the hallmark of capacity collapse, not generalisation.
...
After identifying that M5's aggressive augmentation pipeline hurt performance (−1.8% vs M4), we ran a targeted follow-up: the best-performing architecture `M4_BN_Dropouts` re-trained with **only** `RandomFlip("horizontal")` added.
...
M4       ████████████████████████████████████   70.5%
V5       ████████████████████████████████▌      68.7%  ← Rotation + Zoom + Contrast
M2       ████████████████████████████████       66.9%
M3       ██████████████████████████████▊        64.3%
M6       █████████████████████████▉             54.6%
M1       █████████████████████████▊             54.2%
